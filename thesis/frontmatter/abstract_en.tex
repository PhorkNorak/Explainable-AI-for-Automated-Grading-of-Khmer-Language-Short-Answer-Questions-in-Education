...
Weighted Kappa (QWK) (0.795, 0.845, 0.820, and 0.842, respectively, a narrow 0.05 band), while the
fine-tuned LLM is the clear best on the deployment metrics that matter in a classroom (67\% exact
integer-score match and 79\% agreement within one point). Second, \emph{Leave-One-Out (LOO) word-attribution} (text highlighting) explanations are
